    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                ...
                <p class="text-muted mb-0" style="font-size: 0.85rem;">Here are the company's top performing employees sorted by cumulative evaluation scores.</p>
            </div>
            <a href="rate_employee.php" class="btn btn-primary btn-sm rounded-pill px-3"><i class="bi bi-plus-lg me-1"></i> Evaluate Employee</a>
        </div>
            ...
            <div class="card mb-3 shadow-sm border" style="background-color: <?php echo $bg_color; ?>; border-color: <?php echo $border_color; ?> !important; border-radius: 12px;">
                <div class="card-body p-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center text-end">
                        ...
                        <a href="rate_employee.php?emp_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-light rounded-pill px-3" style="font-size: 0.75rem; border: 1px solid #cbd5e1; color: #3b82f6; font-weight: 600;"><i class="bi bi-star-fill text-warning me-1"></i> Re-evaluate</a>
                    </div>
